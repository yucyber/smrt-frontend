<template>
  <div class="left-group">
    <el-tooltip content="首页" :hide-after="0">
  ...
  <el-dialog v-model="ocrDialog" width="500" title="上传图片">
    ...
    <template #footer>
      <div class="dialog-footer">
        <el-button v-if="!uploadSuccess" @click="ocrDialog = false"
          >取消</el-button
        >
        <el-button
          v-if="!uploadSuccess"
          type="primary"
          @click="ocrUpload.submit()"
          >上传</el-button
        >
        <el-button
          v-if="uploadSuccess"
  ...
  <el-dialog v-model="asrDialog" width="500" title="上传音频">
    <el-upload
      ...
      ref="asrUpload"
      drag
      action="/api/function/asr"
      accept=".wav, .mp3"
      :limit="1"
      :on-exceed="handleExceed"
      :before-upload="checkSpeech"
      :auto-upload="false"
      :on-success="handleSuccess"
    >
      <el-icon class="el-icon--upload"><upload-filled /></el-icon>
    ...
    <template #footer>
      <div class="dialog-footer">
        <el-button v-if="!uploadSuccess" @click="asrDialog = false"
          >取消</el-button
        >
        <el-button
          v-if="!uploadSuccess"
          type="primary"
          @click="asrUpload.submit()"
          >上传</el-button
        >
        <el-button
          v-if="uploadSuccess"
